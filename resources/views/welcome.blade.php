...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Aldin Admin Laravel 10</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
      sizes="16x16"
      href="{{asset('backend/assets/images/icon.png')}}"
    />
    <!-- Custom CSS -->
              ...
              <div class="card">
                ...
                <div class="comment-widgets scrollable">
                  ...
                  <div class="d-flex flex-row comment-row mt-0">
                    <div class="p-2">
                      <img
                        src="{{asset('backend/assets/images/users/11.png')}}"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                  ...
                  <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                      <img
                        src="{{asset('backend/assets/images/users/d3.jpg')}}"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                        ...
                        <ul class="list-style-none assignedto">
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="{{asset('backend/assets/images/users/2.png')}}"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                ...
                <div class="card-body">
                  ...
                  <div class="chat-box scrollable" style="height: 475px">
                    ...
                    <ul class="chat-list">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{asset('backend/assets/images/users/11.png')}}" alt="user" />
                        </div>
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{asset('backend/assets/images/users/2.png')}}" alt="user" />
                        </div>
                        <div class="chat-content">
                ...
                <div class="tab-content tabcontent-border">
                  <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="p-20">
                      ...
                      <img
                        src="{{ asset('/assets/images/background/img4.jpg')}}"
                        class="img-fluid"
                      />
                    </div>
                  </div>
